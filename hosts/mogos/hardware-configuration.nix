...

{
  ...
  fileSystems."/" =
    { device = "/dev/disk/by-uuid/c50cbb0f-efda-4838-b831-7438695db340";
      fsType = "ext4";
    };

  fileSystems."/boot" =
    { device = "/dev/disk/by-uuid/FF05-8506";
      fsType = "vfat";
      options = [ "fmask=0077" "dmask=0077" ];
    };

  swapDevices =
    [ { device = "/dev/disk/by-uuid/a2a39aef-6eb7-4741-adc7-17f1b490896f"; }
    ];
